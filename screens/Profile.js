...
const Profile = (props)=>{
    ...
    const openDial=()=>{
        if(Platform.OS === "android"){
            Linking.openURL("tel:9530990077")
        } else {
            Linking.openURL("telprompt:9530990077")
        }
    }
    return (
        ...
        <Text style={styles.mytext}>{salary}</Text>
            ...
            icon="account-edit" 
            theme={theme}
            mode="contained" onPress={() => Linking.openURL("https://us04web.zoom.us/j/71937260818?pwd=elY2elJjVEpqVGQ0RWR0blZuY1orZz09")}>
                zoom
            </Button>
            <Button 
            icon="delete" 
            theme={theme}
            mode="contained" onPress={() => Linking.openURL("")}>
                Delete
            </Button>
            </View>
